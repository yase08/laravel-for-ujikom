...
class UserController extends Controller
{
    ...
    {
        // Ambil semua pengguna bersama dengan peran-perannya
        $users = User::with('roles')->get();

        // Menggunakan metode pluck, Anda bisa mendapatkan peran untuk setiap pengguna
        // Namun, ingatlah bahwa setiap pengguna dapat memiliki lebih dari satu peran
        // Jadi, hasilnya akan menjadi array peran untuk setiap pengguna
